        ...
        >
          ...
          <li>
            ...
            >
              ...
              ><span class="ms-1 d-none d-sm-inline text-secondary"
                >Dashboard</span
              >
            </a>
          </li>
          ...
          <li class="dropdown">
            ...
            >
              ...
              <li>
                <a class="dropdown-item text-secondary" href="#">Profile</a>
              </li>
              <li>
                <hr class="dropdown-divider text-secondary" />
              </li>
              <li>
                <a class="dropdown-item text-secondary" href="#">Sign out</a>
              </li>
            </ul>
          </li>
          <li>
...
<script>
export default {
  name: "Sidebar", // Use a multi-word name
